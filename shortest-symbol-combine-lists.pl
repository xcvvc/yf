...
open RUSSELL, ("<text-files/russell.txt") or die;
while( $line = <RUSSELL> )
{
chomp $line;
@_ = split ("\t", $line);
...
open SP600, ("<text-files/sp600.txt") or die;
...
open SP400, ("<text-files/sp400.txt") or die;
...
open SP500, ("<text-files/sp500.txt") or die;
...
open OUTLIST, (">update-symbol-list.txt");
